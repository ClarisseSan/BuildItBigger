 ...
 * on 2016-10-15 at 09:26:25 UTC 
 * Modify at your own risk.
 */

package com.example.isse.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "displayJoke".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link DisplayJoke#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public DisplayJoke displayJoke() throws java.io.IOException {
    DisplayJoke result = new DisplayJoke();
    initialize(result);
    return result;
  }

  public class DisplayJoke extends MyApiRequest<com.example.isse.myapplication.backend.myApi.model.MyJoke> {

    private static final String REST_PATH = "displayJoke";

    /**
     * Create a request for the method "displayJoke".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link DisplayJoke#execute()} method to invoke the remote operation. <p>
     * {@link
     * DisplayJoke#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected DisplayJoke() {
      super(MyApi.this, "POST", REST_PATH, null, com.example.isse.myapplication.backend.myApi.model.MyJoke.class);
    }

    @Override
    public DisplayJoke setAlt(java.lang.String alt) {
      return (DisplayJoke) super.setAlt(alt);
    }

    @Override
    public DisplayJoke setFields(java.lang.String fields) {
      return (DisplayJoke) super.setFields(fields);
    }

    @Override
    public DisplayJoke setKey(java.lang.String key) {
      return (DisplayJoke) super.setKey(key);
    }

    @Override
    public DisplayJoke setOauthToken(java.lang.String oauthToken) {
      return (DisplayJoke) super.setOauthToken(oauthToken);
    }

    @Override
    public DisplayJoke setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (DisplayJoke) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public DisplayJoke setQuotaUser(java.lang.String quotaUser) {
      return (DisplayJoke) super.setQuotaUser(quotaUser);
    }

    @Override
    public DisplayJoke setUserIp(java.lang.String userIp) {
      return (DisplayJoke) super.setUserIp(userIp);
    }

    @Override
    public DisplayJoke set(String parameterName, Object value) {
      return (DisplayJoke) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.isse.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.isse.myapplication.backend.myApi.model.MyBean.class);
